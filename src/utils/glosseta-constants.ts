...
export const GLOSSETA_API_ENDPOINT = "https://perma.storedat.io/api/v1/graphql";

export const TERM_TAG = "term" as String;
export const DESCRIPTION_TAG = "description" as String;
export const SOURCE_TAG = "source" as String;
export const CATEGORY_TAG = "category" as String;
export const TRANSACTION_ID = "id" as String;