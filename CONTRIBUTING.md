...
## How to work on definition intake requests

Please follow the [how to guide](https://github.com/narbs91/glosseta/wiki/How-to-guide:-Definition-intake-request) on how to approach working on a definition intake request issue
